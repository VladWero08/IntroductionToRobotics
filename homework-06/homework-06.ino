...
int photocell_value;
int photocell_threshold;                // maximum value allowed for the photocell
...
int ultrasonic_threshold;               // maximum distance allowed for the ultrasonic 
...
// from byte 20-39, photocell logs
...
/* variables related to errors of each menu of 
...
void choose_menu_to_display(){
  switch (current_menu) {
    case 0:
      Serial.println("Press the labeled number to enter in the desired menu:");
    ...
    case 41:
      ...
      Serial.print("`255 255 255`, 1st: R, 2nd: G, 3rd B: ");
      Serial.println();
      break;
    default:
      break;
